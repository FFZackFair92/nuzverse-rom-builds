...
#define OW_DOUBLE_APPROACH_WITH_ONE_MON TRUE       // Nuzverse IronMon: lotte doppie anche con UN solo Pokemon (1 vs 2). Era FALSE.
...
#if NV_KAIZO
#define OW_GFX_COMPRESS                FALSE      // Nuzverse: con OWE attivi, FALSE evita problemi di VRAM (consigliato dall'expansion).
#else
